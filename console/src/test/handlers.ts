...
export const tutorials = [
  ...
  { id: 'video-rag', slug: 'video-rag', title: '视频 RAG', summary: '将视频理解、时间片段证据、字幕和音频信息纳入同一检索链路。', version: '1.0.0', status: 'published', modality: 'video', difficulty: 'advanced', estimated_duration_minutes: 75, source_benchmark: 'Video-MME', source_url: 'https://video-mme.github.io/home_page.html', scenario_dimensions: ['短视频', '中视频', '长视频', '视觉信息', '字幕', '音频', '时间否定', '错误前提', '信息不足'], pipeline_stages: ['P0 基线', 'P1 视频理解与打标', 'P2 时间分段', 'P3 Contextual Retrieval', 'P4 稀疏召回', 'P5 多路召回', 'P6 Rewrite', 'P7 Rerank', 'P8 组合策略'], required_capabilities: ['doubao_seed_video_understanding', 'temporal_index', 'embedding', 'rerank'], packs: packs('video-rag'), replay_available: false },
]

const officialReplay = {
  id: 'text-rag/1.0.0/benchmark/replay-v1', template_id: 'text-rag', template_version: '1.0.0', pack_tier: 'benchmark',
  pack_manifest_sha256: 'd3b293d5478d03ec7cc37bd0fbc837c1a9a017764c457c4a1001ece25d890e26', runtime_environment_sha256: '7f0c9da0fedc8246fe5cb2c74ddc0a6f3e4c5f5b1f9fe2671c54d6472cb947a1', build_revision: 'official-replay-v1', evaluator_version: 'tutorial_eval_v5', generated_at: '2026-07-16T00:00:00Z',
  summary: '受控 Benchmark Pack 的离线官方复现摘要；展示运行定义与聚合审计事实，不代表当前用户环境的 Live Run。', fingerprint: '156d30b9fa97d0152cd384a3cbf9f199ad10e43a807d5141a165d32d517f975f',
  baseline: { variant: 'baseline', profile: 'high_precision', top_k: 8, context_pack_top_n: 5, context_pack_max_tokens: 6000, metrics: [{ name: 'evaluation_items', value: 4 }, { name: 'retrieval_top_k', value: 8 }], index_metrics: [{ name: 'source_documents', value: 2 }, { name: 'reused_baseline_index', value: 0 }] },
  candidate: { variant: 'p8_context_pack', profile: 'high_precision', top_k: 8, context_pack_top_n: 3, context_pack_max_tokens: 6000, metrics: [{ name: 'evaluation_items', value: 4 }, { name: 'retrieval_top_k', value: 8 }], index_metrics: [{ name: 'source_documents', value: 2 }, { name: 'reused_baseline_index', value: 1 }] },
} as const
...
export const tutorialExperiment = {
  ...
  variants: [
    { id: 'baseline', chapter: 'p0_basic_baseline', parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval: false, retrieval_strategy: 'hybrid', reuse_baseline_index: false, context_pack_top_n: 5, context_pack_max_tokens: 6000, available: true },
    { id: 'p1_structured_json', chapter: 'p1_document_parser', parser_method: 'structured_json', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval: false, retrieval_strategy: 'hybrid', reuse_baseline_index: false, available: true },
    ...
    { id: 'p6_rerank_retrieval', chapter: 'p6_rerank_retrieval', parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval: false, retrieval_strategy: 'hybrid', reuse_baseline_index: true, rerank_enabled: true, available: true },
    { id: 'p7_graph_retrieval', chapter: 'p7_graph_retrieval', parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval: false, retrieval_strategy: 'graph', reuse_baseline_index: false, graph_retrieval_enabled: true, available: true },
    { id: 'p8_context_pack', chapter: 'p8_context_pack', parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval: false, retrieval_strategy: 'hybrid', reuse_baseline_index: true, context_pack_top_n: 3, context_pack_max_tokens: 6000, available: true },
  ],
...
export const completedTutorialRun = {
  ...
  variant: 'baseline', parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: false, retrieval_strategy: 'hybrid', reused_baseline_index: false, query_expansion_mode: 'none', multi_query_count: 0, rerank_enabled: false, context_pack_top_n: 5, context_pack_max_tokens: 6000, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 0, average_context_tokens: 0, comparison_fingerprint: 'comparison_fingerprint', knowledge_base_id: 'tkb_clone', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone',
...
const completedTutorialP3Run = {
  ...
  variant: 'p3_contextual_retrieval', baseline_run_id: completedTutorialRun.id, parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: true, retrieval_strategy: 'hybrid', reused_baseline_index: false, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 2, average_context_tokens: 18, comparison_fingerprint: 'comparison_fingerprint', definition_fingerprint: 'p3_definition_fingerprint', knowledge_base_id: 'tkb_clone_p3', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone_p3',
...
const completedTutorialP4Run = {
  id: 'terun_clone_p4', tenant_id: 'tenant_a', project_id: completedCloneJob.project_id, experiment_id: tutorialExperiment.id,
  variant: 'p4_sparse_retrieval', baseline_run_id: completedTutorialRun.id, parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: false, retrieval_strategy: 'sparse', reused_baseline_index: true, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 0, average_context_tokens: 0, comparison_fingerprint: 'comparison_fingerprint', definition_fingerprint: 'p4_definition_fingerprint', knowledge_base_id: 'tkb_clone', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone_p4',
  events: [{ stage: 'run_evaluation', outcome: 'completed', occurred_at: '2026-07-16T00:04:00Z' }, { stage: 'completed', outcome: 'completed', occurred_at: '2026-07-16T00:04:01Z' }],
...
const completedTutorialP6Run = {
  id: 'terun_clone_p6', tenant_id: 'tenant_a', project_id: completedCloneJob.project_id, experiment_id: tutorialExperiment.id,
  variant: 'p6_rerank_retrieval', baseline_run_id: completedTutorialRun.id, parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: false, retrieval_strategy: 'hybrid', reused_baseline_index: true, query_expansion_mode: 'none', multi_query_count: 0, rerank_enabled: true, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 0, average_context_tokens: 0, comparison_fingerprint: 'comparison_fingerprint', definition_fingerprint: 'p6_definition_fingerprint', knowledge_base_id: 'tkb_clone', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone_p6',
  events: [{ stage: 'run_evaluation', outcome: 'completed', occurred_at: '2026-07-16T00:06:00Z' }, { stage: 'completed', outcome: 'completed', occurred_at: '2026-07-16T00:06:01Z' }],
  created_at: '2026-07-16T00:06:00Z', updated_at: '2026-07-16T00:06:01Z',
} as const

const completedTutorialP7Run = {
  id: 'terun_clone_p7', tenant_id: 'tenant_a', project_id: completedCloneJob.project_id, experiment_id: tutorialExperiment.id,
  variant: 'p7_graph_retrieval', baseline_run_id: completedTutorialRun.id, parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: false, retrieval_strategy: 'graph', reused_baseline_index: false, query_expansion_mode: 'none', multi_query_count: 0, rerank_enabled: false, graph_retrieval_enabled: true, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 0, average_context_tokens: 0, comparison_fingerprint: 'comparison_fingerprint', definition_fingerprint: 'p7_definition_fingerprint', knowledge_base_id: 'tkb_clone_p7', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone_p7',
  events: [{ stage: 'index_private_pack', outcome: 'completed', occurred_at: '2026-07-16T00:07:00Z' }, { stage: 'run_evaluation', outcome: 'completed', occurred_at: '2026-07-16T00:07:01Z' }, { stage: 'completed', outcome: 'completed', occurred_at: '2026-07-16T00:07:02Z' }],
  created_at: '2026-07-16T00:07:00Z', updated_at: '2026-07-16T00:07:02Z',
} as const

const completedTutorialP8Run = {
  id: 'terun_clone_p8', tenant_id: 'tenant_a', project_id: completedCloneJob.project_id, experiment_id: tutorialExperiment.id,
  variant: 'p8_context_pack', baseline_run_id: completedTutorialRun.id, parser_method: 'basic', chunk_size_tokens: 800, chunk_overlap_tokens: 120, contextual_retrieval_enabled: false, retrieval_strategy: 'hybrid', reused_baseline_index: true, query_expansion_mode: 'none', multi_query_count: 0, rerank_enabled: false, graph_retrieval_enabled: false, context_pack_top_n: 3, context_pack_max_tokens: 6000, indexed_chunk_count: 2, average_chunk_tokens: 600, contextualized_chunk_count: 0, average_context_tokens: 0, comparison_fingerprint: 'comparison_fingerprint', definition_fingerprint: 'p8_definition_fingerprint', knowledge_base_id: 'tkb_clone', dataset_id: 'tds_clone', profile: 'realtime', top_k: 5, stage: 'completed', status: 'completed', evaluation_run_id: 'eval_tutorial_clone_p8',
  events: [{ stage: 'run_evaluation', outcome: 'completed', occurred_at: '2026-07-16T00:08:00Z' }, { stage: 'completed', outcome: 'completed', occurred_at: '2026-07-16T00:08:01Z' }],
  created_at: '2026-07-16T00:08:00Z', updated_at: '2026-07-16T00:08:01Z',
} as const
...
const tutorialP6Comparison = {
  baseline: completedTutorialRun, candidate: completedTutorialP6Run, comparable: true,
  metrics: [{ name: 'accuracy', baseline: 0.5, candidate: 0.75, absolute_delta: 0.25, relative_delta: 0.5 }],
  index_metrics: [{ name: 'average_chunk_tokens', baseline: 600, candidate: 600, absolute_delta: 0, relative_delta: 0 }, { name: 'chunk_count', baseline: 2, candidate: 2, absolute_delta: 0, relative_delta: 0 }],
} as const

const tutorialP7Comparison = {
  baseline: completedTutorialRun, candidate: completedTutorialP7Run, comparable: true,
  metrics: [{ name: 'accuracy', baseline: 0.5, candidate: 0.75, absolute_delta: 0.25, relative_delta: 0.5 }],
  index_metrics: [{ name: 'average_chunk_tokens', baseline: 600, candidate: 600, absolute_delta: 0, relative_delta: 0 }, { name: 'chunk_count', baseline: 2, candidate: 2, absolute_delta: 0, relative_delta: 0 }],
} as const

const tutorialP8Comparison = {
  baseline: completedTutorialRun, candidate: completedTutorialP8Run, comparable: true,
  metrics: [{ name: 'accuracy', baseline: 0.5, candidate: 0.75, absolute_delta: 0.25, relative_delta: 0.5 }],
  index_metrics: [{ name: 'average_chunk_tokens', baseline: 600, candidate: 600, absolute_delta: 0, relative_delta: 0 }, { name: 'chunk_count', baseline: 2, candidate: 2, absolute_delta: 0, relative_delta: 0 }],
} as const
...
export function useTutorialLiveRunHandlers() {
  server.use(
    ...
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p6', () => HttpResponse.json(completedTutorialP6Run)),
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p6/comparison', () => HttpResponse.json(tutorialP6Comparison)),
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p7', () => HttpResponse.json(completedTutorialP7Run)),
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p7/comparison', () => HttpResponse.json(tutorialP7Comparison)),
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p8', () => HttpResponse.json(completedTutorialP8Run)),
    http.get('/v1/projects/prj_clone/tutorial-experiments/texp_clone/runs/terun_clone_p8/comparison', () => HttpResponse.json(tutorialP8Comparison)),
