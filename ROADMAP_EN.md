...
- Migration status, Qdrant collection compatibility checks, disaster-recovery documentation, and a backup-artifact verifier are available; retain real backup/restore drill evidence from independent reference deployments next.
