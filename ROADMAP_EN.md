...
- Clone and Pack installation, `text-rag` Quick P0–P8 candidates, the controlled Benchmark Run, and the offline read-only official text-rag Replay are complete with frozen inputs, durable reproduction evidence, actual evaluation metrics for Live Runs, and measured index facts. Visual-document/video Replay and execution remain pending; default public OSS availability and official Pack publication remain external prerequisites.
