...
.PHONY: run test vet fmt tidy dev-up dev-down migrate openapi-validate docker-build docker-run test-integration test-integration-up test-integration-down
