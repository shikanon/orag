...
func projectScopedRouteSupported(c *app.RequestContext) bool {
	...
	case "/v1/projects/:project_id",
		...
		"/v1/projects/:project_id/pipelines", "/v1/projects/:project_id/pipelines/:pipeline_id/draft", "/v1/projects/:project_id/query:debug", "/v1/projects/:project_id/debug-runs/:run_id/save-case",
