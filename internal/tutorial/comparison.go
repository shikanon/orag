...
func isComparableTutorialCandidate(candidate ExperimentRun) bool {
	...
	case TutorialP1StructuredJSONCandidateID:
		return candidate.ParserMethod == TutorialStructuredJSONParserMethod && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && runRetrievalStrategy(candidate) == TutorialRetrievalStrategyHybrid && !candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && !candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens
	...
	case TutorialP3ContextualCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && candidate.ContextualRetrievalEnabled && runRetrievalStrategy(candidate) == TutorialRetrievalStrategyHybrid && !candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && !candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.ContextualizedChunkCount > 0 && candidate.AverageContextTokens > 0
	case TutorialP4SparseCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && candidate.RetrievalStrategy == TutorialRetrievalStrategySparse && candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && !candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.KnowledgeBaseID != ""
	case TutorialP5MultiQueryCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && candidate.RetrievalStrategy == TutorialRetrievalStrategyHybrid && candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionMultiQuery && candidate.MultiQueryCount == 3 && !candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.KnowledgeBaseID != ""
	case TutorialP6RerankCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && candidate.RetrievalStrategy == TutorialRetrievalStrategyHybrid && candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.KnowledgeBaseID != ""
	case TutorialP7GraphCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && candidate.RetrievalStrategy == TutorialRetrievalStrategyGraph && !candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && !candidate.RerankEnabled && candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialBaselineContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.KnowledgeBaseID != ""
	case TutorialP8ContextPackCandidateID:
		return candidate.ParserMethod == "basic" && candidate.ChunkSizeTokens == TutorialBaselineChunkSizeTokens && candidate.ChunkOverlapTokens == TutorialBaselineChunkOverlapTokens && !candidate.ContextualRetrievalEnabled && candidate.RetrievalStrategy == TutorialRetrievalStrategyHybrid && candidate.ReusedBaselineIndex && runQueryExpansionMode(candidate) == TutorialQueryExpansionNone && candidate.MultiQueryCount == 0 && !candidate.RerankEnabled && !candidate.GraphRetrievalEnabled && candidate.ContextPackTopN == TutorialP8ContextPackTopN && candidate.ContextPackMaxTokens == TutorialContextPackMaxTokens && candidate.KnowledgeBaseID != ""
	default:
		return false
	}
}
