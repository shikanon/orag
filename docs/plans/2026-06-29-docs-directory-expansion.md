...
- Create: `docs/getting-started/api-smoke.md`
- Create: `docs/api/README.md`
- Create: `docs/api/auth-and-errors.md`
- Create: `docs/api/ingestion-and-query.md`
- Create: `docs/architecture/README.md`
- Create: `docs/architecture/rag-pipeline.md`
