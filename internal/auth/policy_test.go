...
func TestAuthorizeMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		{"admin starts tutorial clone", admin, ActionTutorialCloneCreate, "tenant_1", "", true},
		{"editor cannot start tenant tutorial clone", editor, ActionTutorialCloneCreate, "tenant_1", "", false},
		{"editor reads own tutorial clone", editor, ActionTutorialCloneRead, "tenant_1", "prj_1", true},
		{"viewer cannot retry tutorial clone", viewer, ActionTutorialCloneRetry, "tenant_1", "prj_1", false},
