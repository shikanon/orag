...
受控 `tests/fixtures/tutorial-packs/text-rag/1.0.3/quick` 仅供真实 PostgreSQL/Qdrant/浏览器回归临时映射，不会覆盖公开 `1.0.0` Pack。正式公开 1.0.3 仍须通过独立匿名 HTTPS、MIME、长度和 SHA-256 发布流程。
