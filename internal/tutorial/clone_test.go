...
func TestPublicExperimentExposesDeclaredVariantsWithoutManifest(t *testing.T) {
	...
	if len(public.Variants) != 9 || public.Variants[0].ID != "baseline" || public.Variants[0].RetrievalStrategy != TutorialRetrievalStrategyHybrid || public.Variants[0].ContextualRetrieval || public.Variants[0].ChunkSizeTokens != TutorialBaselineChunkSizeTokens || public.Variants[1].ID != TutorialP1StructuredJSONCandidateID || public.Variants[2].ID != TutorialP2RecursiveChunkCandidateID || public.Variants[2].ChunkSizeTokens != TutorialP2ChunkSizeTokens || public.Variants[2].ChunkOverlapTokens != TutorialP2ChunkOverlapTokens || public.Variants[2].ContextualRetrieval || public.Variants[3].ID != TutorialP3ContextualCandidateID || !public.Variants[3].ContextualRetrieval || public.Variants[4].ID != TutorialP4SparseCandidateID || public.Variants[4].RetrievalStrategy != TutorialRetrievalStrategySparse || !public.Variants[4].ReuseBaselineIndex || public.Variants[5].ID != TutorialP5MultiQueryCandidateID || public.Variants[5].MultiQueryCount != 3 || !public.Variants[5].ReuseBaselineIndex || public.Variants[6].ID != TutorialP6RerankCandidateID || !public.Variants[6].RerankEnabled || !public.Variants[6].ReuseBaselineIndex || public.Variants[7].ID != TutorialP7GraphCandidateID || public.Variants[7].RetrievalStrategy != TutorialRetrievalStrategyGraph || !public.Variants[7].GraphRetrievalEnabled || public.Variants[7].ReuseBaselineIndex || public.Variants[8].ID != TutorialP8ContextPackCandidateID || !public.Variants[8].ReuseBaselineIndex || public.Variants[8].ContextPackTopN != TutorialP8ContextPackTopN || public.Variants[8].ContextPackMaxTokens != TutorialContextPackMaxTokens || !public.Variants[8].Available {
