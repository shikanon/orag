...
- Clone and Pack installation are complete with a controlled-fixture real browser E2E; Quick Run, Benchmark Run, Replay, and result comparison remain pending, and default public OSS availability remains an external prerequisite.
