...
CREATE INDEX IF NOT EXISTS rag_traces_tenant_kb_created_idx
    ON rag_traces (tenant_id, knowledge_base_id, created_at DESC, id);
...
DROP INDEX IF EXISTS rag_traces_tenant_kb_created_idx;
