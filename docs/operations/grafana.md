...
OTLP trace export is optional through `OTEL_EXPORTER_OTLP_ENDPOINT`. There is not yet an OTLP metrics exporter, metrics persistence, sampling policy, or cross-service topology view; use Prometheus as the metrics transport for this release.
